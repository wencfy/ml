...
class RidgeRegression(BaseEstimator, RegressorMixin):
    ...
    def __init__(self, l2_reg=1, step_size=.005,  max_num_epochs = 5000):
        ...
        ## Your code here should include all the steps to finally set self.graph as in the linear regression example but for the ridge regression loss.
        self.loss = nodes.SquaredL2DistanceNode(a=self.prediction, b=self.y, node_name="square loss")
        self.reg = nodes.L2NormPenaltyNode(l2_reg=l2_reg, w=self.w, node_name="l2 regulerization")
        self.objective = nodes.SumNode(a=self.loss, b=self.reg, node_name="ridge loss")
